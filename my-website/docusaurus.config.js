...
const config = {
  ...
  organizationName: 'tim', // Usually your GitHub org/user name.
  projectName: 'tbank', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          routeBasePath: 'docs',
          editUrl:
            'https://github.com/dolgikht17/tbank',
